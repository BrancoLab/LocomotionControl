...
# sys.path.append(
#     os.path.dirname(os.path.abspath(__file__)) + "/../../MotionPlanning/"
# )
...
#         theta_e, e_cg, yaw_ref, k_ref = ref_trajectory.ToTrajectoryFrame(
#             vehicle_state
#         )
...
#                 pi_2_pi(delta_opt), a_opt, e_cg, theta_e, direct
#             )
...
#             plt.axis("equal")
#             plt.title(
#                 "LQR (Dynamics): v=" + str(vehicle_state.v * 3.6)[:4] + "km/h"
#             )
