...
class Hairpin:
    ...
    def __init__(
        self, ax: plt.Axes = None, set_ax = False, **kwargs
    ):
        """
            Renders an image of the hairpin maze on a matplotlib axis
        """
...
class T1(Hairpin):
    ...
    def __init__(
        self, ax: plt.Axes = None, shade=False, **kwargs
    ):
        super().__init__(ax, **kwargs)
        if shade:
            Rectangle(self.x_0, self.x_1, self.y_0, self.y_1, ax=ax, color=salmon, alpha=.2, lw=0)
...
class T2(Hairpin):
    ...
    def __init__(
        ...
        super().__init__(ax, **kwargs)
        if shade:
            Rectangle(self.x_0, self.x_1, self.y_0, self.y_1, ax=ax, color=blue_light, alpha=.2, lw=0)
...
class T3(Hairpin):
    ...
    def __init__(
        ...
        super().__init__(ax, **kwargs)
        if shade:
            Rectangle(self.x_0, self.x_1, self.y_0, self.y_1, ax=ax, color=red_light, alpha=.2, lw=0)
...
class T4(Hairpin):
    ...
    def __init__(
        ...
        super().__init__(ax, **kwargs)
        if shade:
            Rectangle(self.x_0, self.x_1, self.y_0, self.y_1, ax=ax, color=indigo, alpha=.2, lw=0)
...
class S1(Hairpin):
    ...
    def __init__(
        ...
        super().__init__(ax, **kwargs)
        if shade:
            Rectangle(self.x_0, self.x_1, self.y_0, self.y_1, ax=ax, color=green, alpha=.15, lw=0)
...
class S2(Hairpin):
    ...
    def __init__(
        ...
        super().__init__(ax, **kwargs)
        if shade:
            Rectangle(self.x_0, self.x_1, self.y_0, self.y_1, ax=ax, color=teal, alpha=.15, lw=0)
