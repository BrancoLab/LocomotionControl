...
class BaseActor(nn.Module):
    ...
    n_units = (128, 128)  # n units in hidden layer
...
#             nn.Linear(self.n_inputs, self.n_units[0]),
#             nn.ReLU(),
#             # nn.BatchNorm1d(self.n_units[0]),
#             nn.Linear(self.n_units[0], self.n_units[1]),
#             nn.ReLU(),
#             nn.Linear(self.n_units[1], self.n_actions),
#             nn.Tanh(),
#         )
#     #     self.fc1 = nn.Linear(self.n_inputs, self.n_units[0])
#     #     self.relu1 = nn.ReLU()
#     #     self.bn1 = nn.BatchNorm1d(self.n_units[0], track_running_stats=True)
