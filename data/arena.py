...
T1 = ROI('T1', 8, 24, 0, 20, 0.02, .27, salmon)
T2 = ROI('T2', 8, 32, 33, 52, 0.20, .48, blue_light)
T3 = ROI('T3', 24, 40, 0, 20, 0.416, .66, red_light)
T4 = ROI('T4', 24, 40, 0, 20, 0.6, .945, indigo)

S1 = ROI('S1', 32, 40, 20, 45, 0.585, 0.7, green)
S2 = ROI('S2', 32, 40, 20, 45, 0.855, 0.99, teal)
