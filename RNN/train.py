...
sys.path.append("./rnn_cache/")

from RNN.rnn import initialize_rnn
from three_bit_memory import (
    ThreeBitDataset,
    plot_predictions,
)

RNN, _ = initialize_rnn()
...
if FIT:
    rnn = initialize_rnn(tau=50, dt=5,)
    ...
    loss_history = rnn.fit(
        ...
        save_path="./rnn_cache/trained_rnn.pt",
    )

    rnn = RNN.load(
        "./rnn_cache/trained_rnn.pt",
        input_size=3,
        output_size=3,
        autopses=True,
        dale_ratio=None,
