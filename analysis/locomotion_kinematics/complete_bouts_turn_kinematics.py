...
# # load bouts
# # bouts: List[Locomotion] = load_complete_bouts(keep=-1, window=11)
...
# DURATION_TH = PARAMS[ROI.name]["DURATION_TH"]
...
#         logger.warning("The mouse entered and exited the ROI, nicht good")
#         continue
...
#     # check that the turn was fast enough
#     if not turn.body.duration <= DURATION_TH:
#         logger.debug("Discarded because too slow")
#         continue
...
# f.tight_layout()
# f.savefig(
#     f"/Users/federicoclaudi/Documents/Github/LocomotionControl/cache/ROI_{ROI.name}_turn_kinematics.png"
# )
...
# f.savefig(
#     f"/Users/federicoclaudi/Documents/Github/LocomotionControl/cache/ROI_{ROI.name}_turn_kinematics_acceleration.png"
# )
